...
#Signatures.sign
#Signatures.verify
""" pour reqd = requirement 
pour une entrée on a besoin de savoir l'adresse qui ns la envoyé et le montant"""
...
class Tx:
    ...
    def sign(self, private):
        ...
        newsig = SignaturesU.sign(message, private)
    ...
    def is_valid(self):
        ...
        for addr, amount in self.inputs:
            found = False
            for s in self.sigs:
                if SignaturesU.verify(message, s, addr):
                    found = True 
            if not found:
                return False
            if amount < 0:
            ...
            """en Ajoutant le for addr in self.reqd
            permet de traiter d'autre cas comme le Tx5"""
...
if __name__ == "__main__":
    ...
    pr1, pu1 = SignaturesU.generate_keys()
    pr2, pu2 = SignaturesU.generate_keys()
    pr3, pu3 = SignaturesU.generate_keys()
    pr4, pu4 = SignaturesU.generate_keys()
